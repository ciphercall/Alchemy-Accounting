<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RptJobInfoForm.aspx.cs" Inherits="AlchemyAccounting.CNF.report.ui.RptJobInfoForm" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td style="width: 84%; margin-left: 120px;">
                    <asp:TextBox runat="server" ID="txtBranchID" CssClass="txtColor center" Width="30%"
                    ...
                    &nbsp;&nbsp;&nbsp; <b> Job Type :</b>&nbsp;<asp:DropDownList runat="server" ID="ddlJobType" CssClass="txtColor center" Width="12%" TabIndex="2"
                        ReadOnly="true" AutoPostBack="True" OnSelectedIndexChanged="ddlJobType_SelectedIndexChanged">
                        <asp:ListItem Value="EXPORT">EXPORT</asp:ListItem>
                        <asp:ListItem Value="IMPORT">IMPORT</asp:ListItem>
                    </asp:DropDownList>
                    &nbsp;&nbsp;&nbsp; <b>Job Year :</b>&nbsp;&nbsp;&nbsp;
                    <asp:TextBox runat="server" ID="txtJobYear" CssClass="txtColor center" Width="15%" TabIndex="3"
                        AutoPostBack="True" OnTextChanged="txtJobYear_TextChanged" Height="22px"></asp:TextBox>
            ...
            <tr>
                ...
                <td style="width: 1%; text-align: center; font-weight: bold">
                    &nbsp;</td>
                <td style="width: 84%">
                    <asp:Button ID="btnSubmit" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="15px" TabIndex="4"
