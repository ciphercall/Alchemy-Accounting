<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt-regID-year-wise-job.aspx.cs" Inherits="AlchemyAccounting.CNF.report.vis_rep.rpt_regID_year_wise_job" %>
    ...
    <div>
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 58%; text-align: left; font-family: Calibri">
                    <strong>STATION WISE JOB REGISTER</strong></td>
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 18%;">
                    <asp:Label runat="server" ID="lblRegID" Font-Names="Calibri;font-size:14px;"></asp:Label>
                </td>
