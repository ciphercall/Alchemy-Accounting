<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt-job-bill-status-station.aspx.cs" Inherits="AlchemyAccounting.CNF.report.vis_rep.rpt_job_bill_status_station" %>
    ...
    <div>
        <div>
            <table style="width: 100%; font-family: Calibri;">
                ...
                <tr>
                    <td style="width: 60%">
                        <strong>STATION WISE BILL STATUS</strong>
                    </td>
                    <td style="text-align: right; width: 40%">
