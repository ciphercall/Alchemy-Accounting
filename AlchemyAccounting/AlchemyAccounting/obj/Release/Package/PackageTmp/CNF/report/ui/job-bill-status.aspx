<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="job-bill-status.aspx.cs" Inherits="AlchemyAccounting.CNF.report.ui.job_bill_status" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="header">
        <h1 align="center" style="font-weight:bold;">Job Wise Bill Status</h1>
    </div>
    <div>
