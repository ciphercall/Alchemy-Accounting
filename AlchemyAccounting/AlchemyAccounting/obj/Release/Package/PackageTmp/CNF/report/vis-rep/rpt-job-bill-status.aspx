<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt-job-bill-status.aspx.cs"
    Inherits="AlchemyAccounting.CNF.report.vis_rep.rpt_job_bill_status" %>
    ...
    <div>
        <div>
            <table style="width: 100%; font-family: Calibri;">
                ...
                <tr>
                    <td style="width: 60%">
                        <strong>JOB WISE BILL STATUS</strong>
                    </td>
                    <td style="text-align: right; width: 40%">
