<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="job-bill-status-party.aspx.cs" Inherits="AlchemyAccounting.CNF.report.ui.job_bill_status_party" %>
            ...
            <tr>
                ...
                <td class="style2">
                    <asp:TextBox ID="txtPartyNM" runat="server" AutoPostBack="True" CssClass="txtColor"
                        OnTextChanged="txtPartyNM_TextChanged" TabIndex="6" Width="100%"></asp:TextBox>
