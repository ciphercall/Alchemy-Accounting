<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt-Periodic-Detailed-Performace.aspx.cs" Inherits="AlchemyAccounting.CNF.report.vis_rep.rpt_Periodic_Detailed_Performace" %>
        ...
        <div>
            <table style="width: 100%; border-bottom: 1px solid">
                ...
                <tr>
                    <td class="style10">&nbsp;</td>
                    <td class="style11">
                        <strong>Receipts Periodic Job Date Wise Detailed Performace Report of C&F (Sea+Air+Local) Job</strong></td>
                    <td style="text-align: right">&nbsp;</td>
                    <td style="text-align: right">&nbsp;</td>
                </tr>
                <tr>
