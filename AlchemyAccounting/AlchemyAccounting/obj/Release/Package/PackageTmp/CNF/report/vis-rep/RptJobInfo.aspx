        ...
        <div>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 48%; text-align: left; font-size: 19PX; font-family: Calibri">Job Register
                    </td>
            ...
            <table width="100%">
                <tr>
                    <td style="width: 2%; text-align: left"></td>
                    <td style="width: 13%; text-align: left; font-family: Calibri; font-size: 14px;">&nbsp;Branch&nbsp;&nbsp;&nbsp;
                    </td>
                    <td style="width: 1%; text-align: center">:
                    </td>
                    <td style="width: 43%">
                ...
                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" Font-Names="Calibri"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DOCRCVDT" HeaderText="Invoice Date">
                          ...
                          <asp:BoundField DataField="LCNO" HeaderText="L/C No">
                            <HeaderStyle HorizontalAlign="Center" Width="8%" />
                            <ItemStyle HorizontalAlign="Left" Width="8%" />
                        </asp:BoundField>
