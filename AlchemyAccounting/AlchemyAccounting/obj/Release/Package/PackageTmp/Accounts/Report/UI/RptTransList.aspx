<%@ Page Title="Transaction List" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="RptTransList.aspx.cs" Inherits="AlchemyAccounting.Accounts.Report.UI.RptTransList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="header">
        <h1 align="center" style="font-weight:bold;">TRANSACTION LISTING</h1>
    </div>
    <div>
        <table id="s_top">
            <tr>
