<%@ Page Title = "Trial Balance Details" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="TrialBalanceDetails.aspx.cs" Inherits="AlchemyAccounting.Accounts.Report.UI.TrialBalanceDetails" %>
...
<script type ="text/javascript">
    $(document).ready(function () {
        $("#txtFromDate,#txtToDate").datepicker({ dateFormat: "dd/mm/yy", changeMonth: true, changeYear: true, yearRange: "-100:+0" });
    });
</script>
            ...
            <tr>
                ...
                <td class="style3">
                    <asp:TextBox ID="txtFromDate" runat="server" AutoPostBack="True" 
                        ClientIDMode="Static" ontextchanged="txtFromDate_TextChanged"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="text-align: left">
                    <asp:TextBox ID="txtToDate" runat="server" AutoPostBack="True" 
                        ClientIDMode="Static" ontextchanged="txtToDate_TextChanged"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
