<%@ Page Title="Ledger Book" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="RptLedgerBook.aspx.cs" Inherits="AlchemyAccounting.Accounts.Report.UI.RptLedgerBook" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="header">
        <h1 align="center" style="font-weight:bold;">Ledger Book</h1>
    </div>
    <div>
        <table id="s_top">
            <tr>
                <td class="style3">
                    <asp:Label ID="lblAccHeadCD" runat="server"></asp:Label>
                </td>
                <td class="style1">
                    &nbsp;</td>
                <td class="style2">
            ...
            <tr>
                ...
                <td class="style1">
                    <strong>:</strong></td>
                <td class="style2">
                    <asp:TextBox ID="txtHeadNM" runat="server" Width="247px" AutoPostBack="True" 
