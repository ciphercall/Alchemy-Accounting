...
namespace AlchemyAccounting.Accounts.UI
{
    public partial class SingleTransaction : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else if (txtCostPool.Text == "")
            {
                lblErrMSg.Visible = true;
                lblErrMSg.Text = "Select Branch Name.";
                txtCostPool.Focus();
            }
            else if (lblCostpoolID.Text == "")
            {
                lblErrMSg.Visible = true;
                lblErrMSg.Text = "Select Branch Name.";
                txtCostPool.Focus();
        ...
        public void Save()
        {
            ...
            try
            {
                ...
                //string s = Session["sdfasd"].ToString();
        ...
        public static string[] GetCompletionListCostPool(string prefixText, int count, string contextKey)
        {
            ...
            {
                cmd = new SqlCommand("SELECT COSTPNM FROM GL_COSTP WHERE COSTPNM LIKE '" + prefixText + "%' AND CATID ='" + brCD + "'", conn);
            }
            SqlDataReader oReader;
            conn.Open();
            List<String> CompletionSet = new List<string>();
        ...
        {
            lblCostpoolID.Text = "";
            Global.lblAdd(@"Select COSTPID FROM GL_COSTP where COSTPNM ='" + txtCostPool.Text + "'", lblCostpoolID);
            if (lblCostpoolID.Text == "")
            {
                lblErrMSg.Visible = true;
                lblErrMSg.Text = "Select Brach Name.";
                txtCostPool.Focus();
            }
            else
            {
