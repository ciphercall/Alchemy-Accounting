    ...
    public partial class EditSingleVoucher : System.Web.UI.Page
    {
        ...
        protected void gvDetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand cmdselectdata = new SqlCommand("SELECT * FROM GL_STRANS where TRANSTP = '" + ddlEditTransType.Text + "' and TRANSDT = '" + edate + "' and TRANSNO = '" + lblTransNo.Text + "'", conn);
                ...
                SqlCommand cmdinsert = new SqlCommand("insert into ASL_DLT values('GL_STRANS',@DESCRP,@USERPC,@USERID,@INTIME,@IPADD)", conn);
