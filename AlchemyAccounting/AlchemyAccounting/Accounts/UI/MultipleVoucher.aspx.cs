...
namespace AlchemyAccounting.Accounts.UI
{
    public partial class MultipleVoucher : System.Web.UI.Page
    {
        ...
        AlchemyAccounting.Accounts.Interface.SingleVoucher iob = new AlchemyAccounting.Accounts.Interface.SingleVoucher();
        ...
        protected void ddlTransType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if (ddlTransType.Text == "JOUR")
                {
                    ...
                    string year = today.ToString("yy");
                    txtTransYear.Text = mon + "-" + year;
                    Global.lblAdd(@"Select max(TRANSNO) FROM GL_MTRANSMST where TRANSMY='" + txtTransYear.Text + "' and TRANSTP = '" + ddlTransType.Text + "'", lblVCount);
                    if (lblVCount.Text == "")
                    {
                        txtVouchNo.Text = "1";
                    }
        ...
        public void ShowGrid()
        {
            ...
            if (uTp == "ADMIN")
            {
                cmd = new SqlCommand(" SELECT GL_MTRANS.TRANSTP, GL_MTRANS.TRANSDT, GL_MTRANS.TRANSMY, GL_MTRANS.TRANSNO, GL_MTRANS.SERIALNO, GL_MTRANS.TRANSFOR, " +
                                            ...
                                            " GL_COSTP.COSTPNM FROM GL_MTRANS LEFT JOIN GL_ACCHART ON GL_MTRANS.DEBITCD = GL_ACCHART.ACCOUNTCD LEFT JOIN " +
            ...
            else
            {
                cmd = new SqlCommand(" SELECT GL_MTRANS.TRANSTP, GL_MTRANS.TRANSDT, GL_MTRANS.TRANSMY, GL_MTRANS.TRANSNO, GL_MTRANS.SERIALNO, GL_MTRANS.TRANSFOR, " +
                                            ...
                                            " GL_COSTP.COSTPNM FROM GL_MTRANS LEFT JOIN GL_ACCHART ON GL_MTRANS.DEBITCD = GL_ACCHART.ACCOUNTCD LEFT JOIN " +
                                            " GL_ACCHART AS GL_ACCHART_1 ON GL_MTRANS.CREDITCD = GL_ACCHART_1.ACCOUNTCD LEFT OUTER JOIN GL_COSTP ON GL_MTRANS.COSTPID = GL_COSTP.COSTPID " +
                                            " WHERE GL_MTRANS.TRANSTP = '" + ddlTransType.Text + "' AND GL_MTRANS.TRANSDT = '" + edate + "' AND GL_MTRANS.TRANSMY = '" + txtTransYear.Text + "' AND GL_MTRANS.TRANSNO = " + txtVouchNo.Text + " AND GL_COSTP.CATID ='" + brCD + "'", conn);
            }
        ...
        public static string[] GetCompletionListCostPool(string prefixText, int count, string contextKey)
        {
            ...
            {
                cmd.CommandText = ("SELECT COSTPNM FROM GL_COSTP WHERE COSTPNM LIKE '" + prefixText + "%' AND CATID ='" + brCD + "'");
            }
        ...
        protected void gvDetails_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("SaveCon"))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (btnEdit.Text == "EDIT")
                        {
                            cmd = new SqlCommand("SELECT TRANSNO FROM GL_MTRANSMST WHERE TRANSTP = '" + ddlTransType.Text + "' AND TRANSDT = '" + trDT + "' AND TRANSMY = '" + txtTransYear.Text + "' AND TRANSNO = " + txtVouchNo.Text + " AND USERID='" + userName + "'", conn);
                        }
                        else  //////// Edit Mode
                        {
                            Int64 EditTransNo = 0;
                        ...
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            else ////Edit Mode
                            {
                                ...
                                query = (" INSERT INTO GL_MTRANS(TRANSTP, TRANSDT, TRANSMY, TRANSNO, SERIALNO, TRANSFOR, COSTPID, TRANSMODE, DEBITCD, CREDITCD, CHEQUENO, CHEQUEDT, AMOUNT, " +
                                         " REMARKS, USERPC, USERID, IPADDRESS, INTIME) " +
                                         " VALUES ('" + ddlTransType.Text + "','" + trDT + "','" + txtTransYear.Text + "'," + EditTransNo + "," + sl + ",'" + ddlTransfor.Text + "', " +
                                         " '" + lblCostPoolID.Text + "','" + ddlTransMode.Text + "','" + lblDebitCD.Text + "','" + lblCreditCD.Text + "','" + txtCheque.Text + "', " +
                                         " '" + cqdt + "','" + txtAmount.Text + "','" + txtRemarks.Text + "','" + PCName + "','" + userName + "','" + ipAddress + "', @INTIME)");
            ...
            else if (e.CommandName.Equals("SavePrint"))
            {
                ...
                else
                {
                    ...
                    string br = lblCostPoolID.Text.Substring(0, 3);
                    Session["branch"] = br;
                    ...
                    else
                    {
                        ...
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            if (btnEdit.Text == "EDIT")
                            {
                                ...
                                comm = new SqlCommand(query, conn);
                                comm.Parameters.Clear();
                                comm.Parameters.AddWithValue("@INTIME", dt);
                                conn.Open();
                                int result = comm.ExecuteNonQuery();
                                conn.Close();
                            ...
                            else ////Edit Mode
                            {
                                ...
                                query = (" INSERT INTO GL_MTRANS(TRANSTP, TRANSDT, TRANSMY, TRANSNO, SERIALNO, TRANSFOR, COSTPID, TRANSMODE, DEBITCD, CREDITCD, CHEQUENO, CHEQUEDT, AMOUNT, " +
                                         ...
                                         " VALUES ('" + ddlTransType.Text + "','" + trDT + "','" + txtTransYear.Text + "'," + EditTransNo + "," + sl + ",'" + ddlTransfor.Text + "', " +
                                         " '" + lblCostPoolID.Text + "','" + ddlTransMode.Text + "','" + lblDebitCD.Text + "','" + lblCreditCD.Text + "','" + txtCheque.Text + "', " +
                                         " '" + cqdt + "','" + txtAmount.Text + "','" + txtRemarks.Text + "','" + PCName + "','" + userName + "', '" + date + "','" + ipAddress + "')");
                        ...
                        else
                        {
                            ...
                            query = " INSERT INTO GL_MTRANSMST (TRANSTP, TRANSDT, TRANSMY, TRANSNO, USERPC, USERID, INTIME, IPADDRESS) " +
                                    " VALUES ('" + ddlTransType.Text + "','" + trDT + "','" + txtTransYear.Text + "'," + txtVouchNo.Text + ",'" + PCName + "','" + userName + "'," + date + ",'" + ipAddress + "')";

                            comm = new SqlCommand(query, conn);
                            cmd.Parameters.Clear();
                            // cmd.Parameters.AddWithValue("@INTIME", date);
                            conn.Open();
                            comm.ExecuteNonQuery();
                            conn.Close();
                ...
                else
                {
                    ...
                    if (btnEdit.Text == "EDIT")
                    {
                        ...
                        SqlCommand cmd = new SqlCommand(" UPDATE GL_MTRANS SET TRANSFOR = '" + ddlTransforEdit.Text + "', COSTPID = '" + lblCostPoolID.Text + "', TRANSMODE = '" + ddlTransModeEdit.Text + "', DEBITCD = '" + lblDebitCD.Text + "', CREDITCD = '" + lblCreditCD.Text + "', CHEQUENO = '" + txtChequeEdit.Text + "', CHEQUEDT = '" + cqdt + "', " +
                                                        " AMOUNT = " + txtAmountEdit.Text + ", REMARKS = '" + txtRemarksEdit.Text + "', USERPC = '" + PCName + "', UPDATEUSERID = '" + userName + "', UPDATETIME =@UPDATETIME, UPDATEIPADDRESS = '" + ipAddress + "' WHERE TRANSTP = '" + ddlTransType.Text + "' AND TRANSDT = '" + trDT + "' AND TRANSMY = '" + txtTransYear.Text + "' AND TRANSNO = " + txtVouchNo.Text + " AND SERIALNO = " + sl + "", conn);
                        cmd.Parameters.Clear();
                    ...
                    else /// Edit Mode
                    {
                        ...
                        conn.Open();
                        SqlCommand cmd = new SqlCommand(" UPDATE GL_MTRANS SET TRANSFOR = '" + ddlTransforEdit.Text + "', COSTPID = '" + lblCostPoolID.Text + "', TRANSMODE = '" + ddlTransModeEdit.Text + "', DEBITCD = '" + lblDebitCD.Text + "', CREDITCD = '" + lblCreditCD.Text + "', CHEQUENO = '" + txtChequeEdit.Text + "', CHEQUEDT = '" + cqdt + "', " +
                                                        " AMOUNT = " + txtAmountEdit.Text + ", REMARKS = '" + txtRemarksEdit.Text + "', USERPC = '" + PCName + "', UPDATEUSERID = '" + userName + "', UPDATETIME =@UPDATETIME, UPDATEIPADDRESS = '" + ipAddress + "' WHERE TRANSTP = '" + ddlTransType.Text + "' AND TRANSDT = '" + trDT + "' AND TRANSMY = '" + txtTransYear.Text + "' AND TRANSNO = " + EditTransNo + " AND SERIALNO = " + sl + "", conn);
                        cmd.Parameters.Clear();
                        cmd.Parameters.AddWithValue("@UPDATETIME", upTM);
            ...
            else
            {
                ...
                if (btnEdit.Text == "EDIT")
                {
                    ...
                    if (ds1.Tables[0].Rows.Count > 1)
                    {
                        ...
                        SqlCommand cmdselectdata = new SqlCommand("SELECT * FROM GL_MTRANS where TRANSTP = '" + ddlTransType.Text + "' and TRANSNO ='" + txtVouchNo.Text + "' AND TRANSMY = '" + txtTransYear.Text + "' and  TRANSDT = '" + trDT + "' and SERIALNO = '" + lblSL.Text + "'", conn);
                        ...
                        string alldata = TRANSTP + ", " + TRANSDT + ", " + TRANSMY + ", " + TRANSNO + ", " + SERIALNO + ", " + TRANSFOR
                            + ", " + COSTPID + ", " + TRANSMODE + ", " + DEBITCD + ", " + DEBITCD + ", " + CREDITCD + ", " + CHEQUENO + ", " + CHEQUEDT + ", " + AMOUNT
                            + ", " + REMARKS + ", " + USERPC + ", " + USERID + ", " + UPDATEUSERID + ", " + INTIME + ", " + UPDATETIME + ", " + IPADDRESS + ", " + UPDATEIPADDRESS;
                        ...
                        SqlCommand cmdinsert = new SqlCommand("insert into ASL_DLT values('GL_MTRANS',@DESCRP,@USERPC,@USERID,@INTIME,@IPADD)", conn);
                        ...
                        //INSERTED Data in TBL_DLT Before Delete
                        ...
                        cmd.ExecuteNonQuery();      //Deleted Data From GL_MTRANS
                        conn.Close();
                    }
                    else
                    {
                        ...
                        string alldataMTRANS = TRANSTP + ", " + TRANSDT + ", " + TRANSMY + ", " + TRANSNO + ", " + SERIALNO + ", " + TRANSFOR
                            + ", " + COSTPID + ", " + TRANSMODE + ", " + DEBITCD + ", " + DEBITCD + ", " + CREDITCD + ", " + CHEQUENO + ", " + CHEQUEDT + ", " + AMOUNT
                            + ", " + REMARKS + ", " + USERPC + ", " + USERID + ", " + UPDATEUSERID + ", " + INTIME + ", " + UPDATETIME + ", " + IPADDRESS + ", " + UPDATEIPADDRESS;
                        ...
                        SqlCommand cmdinsert = new SqlCommand("insert into ASL_DLT values('GL_MTRANS',@DESCRP,@USERPC,@USERID,@INTIME,@IPADD)", conn);
                        cmdinsert.Parameters.AddWithValue("@DESCRP", alldataMTRANS);
                        cmdinsert.Parameters.AddWithValue("@USERPC", userpc);
                        cmdinsert.Parameters.AddWithValue("@USERID", userName);
                        cmdinsert.Parameters.AddWithValue("@INTIME", iob.InTM);
                        cmdinsert.Parameters.AddWithValue("@IPADD", ipadd);
                        ...
                        //INSERTED Data in TBL_DLT Before Delete GL_MTRANS

                        SqlCommand cmd = new SqlCommand("delete from GL_MTRANS where TRANSTP = '" + ddlTransType.Text + "' and TRANSNO ='" + txtVouchNo.Text + "' AND TRANSMY = '" + txtTransYear.Text + "' and  TRANSDT = '" + trDT + "' and SERIALNO = '" + lblSL.Text + "'", conn);
                        cmd.ExecuteNonQuery();
                        //Deleted Data From GL_MTRANS
                        ...
                        string MSTUSERPC = "";
                        string MSTUSERID = "";
                        string MSTUPDATEUSERID = "";
                        string MSTINTIME = "";
                        string MSTUPDATETIME = "";
                        string MSTIPADDRESS = "";
                        string MSTUPDATEIPADDRESS = "";

                        SqlCommand cmdselectdatamst = new SqlCommand("SELECT * FROM GL_MTRANSMST where TRANSTP = '" + ddlTransType.Text + "' and TRANSNO ='" + txtVouchNo.Text + "' AND TRANSMY = '" + txtTransYear.Text + "' and  TRANSDT = '" + trDT + "'", conn);

                        SqlDataReader drmst = cmdselectdatamst.ExecuteReader();
                        while (drmst.Read())
                        {
                            MSTTRANSTP = drmst["TRANSTP"].ToString();
                            MSTTRANSDT = drmst["TRANSDT"].ToString();
                            MSTTRANSMY = drmst["TRANSMY"].ToString();
                            MSTTRANSNO = drmst["TRANSNO"].ToString();
                            MSTUSERPC = drmst["USERPC"].ToString();
                            MSTUSERID = drmst["USERID"].ToString();
                            MSTUPDATEUSERID = drmst["UPDATEUSERID"].ToString();
                            MSTINTIME = drmst["INTIME"].ToString();
                            MSTUPDATETIME = drmst["UPDATETIME"].ToString();
                            MSTIPADDRESS = drmst["IPADDRESS"].ToString();
                            MSTUPDATEIPADDRESS = drmst["UPDATEIPADDRESS"].ToString();
                        }
                        drmst.Close();

                        string alldataMTRANSMST = MSTTRANSTP + ", " + MSTTRANSDT + ", " + MSTTRANSMY + ", " + MSTTRANSNO
                            + ", " + MSTUSERPC + ", " + MSTUSERID + ", " + MSTUPDATEUSERID + ", " + MSTINTIME + ", " + MSTUPDATETIME + ", " + MSTIPADDRESS + ", " + MSTUPDATEIPADDRESS;

                        SqlCommand cmdinsertMST = new SqlCommand("insert into ASL_DLT values('GL_MTRANSMST',@DESCRP,@USERPC,@USERID,@INTIME,@IPADD)", conn);
                        cmdinsertMST.Parameters.AddWithValue("@DESCRP", alldataMTRANSMST);
                        cmdinsertMST.Parameters.AddWithValue("@USERPC", userpc);
                        cmdinsertMST.Parameters.AddWithValue("@USERID", userName);
                        cmdinsertMST.Parameters.AddWithValue("@INTIME", iob.InTM);
                        cmdinsertMST.Parameters.AddWithValue("@IPADD", ipadd);
                        cmdinsertMST.ExecuteNonQuery();

                        //INSERTED Data in TBL_DLT Before Delete GL_MTRANSMST
                        ...
                        //Deleted Data From GL_MTRANSMST
            ...
            else
            {
                ...
                if (btnEdit.Text == "EDIT")
                {
                    ...
                    else
                    {
                        ...
                        Global.dropDownAddWithSelect(ddlVouch, "SELECT DISTINCT GL_MTRANS.TRANSNO FROM GL_MTRANS INNER JOIN GL_COSTP ON GL_MTRANS.COSTPID = GL_COSTP.COSTPID WHERE GL_MTRANS.TRANSTP ='" + ddlTransType.Text + "' AND GL_MTRANS.TRANSMY ='" + txtTransYear.Text + "' AND GL_MTRANS.TRANSDT ='" + trDT + "' AND GL_COSTP.CATID ='" + brCD + "'");
                    }
                    ddlVouch.SelectedIndex = -1;
                    ShowGrid_Edit();
                    ddlTransType.Focus();
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    DateTime tr = DateTime.Parse(txtTransDate.Text, dateformat, System.Globalization.DateTimeStyles.AssumeLocal);
                    string tdt = tr.ToString("yyyy-MM-dd");

                    Global.lblAdd("SELECT DISTINCT COSTPID FROM GL_MTRANS WHERE TRANSTP ='" + ddlTransType.Text + "' AND  TRANSDT = '" + tdt + "' AND TRANSNO =" + ddlVouch.Text + "", lblCostPoolID);
                    string br = lblCostPoolID.Text.Substring(0, 3);
                    Session["branch"] = null;
                    Session["branch"] = br;
