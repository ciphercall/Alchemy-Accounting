...
namespace AlchemyAccounting.Accounts.UI
{
    public partial class OpeningBalance : System.Web.UI.Page
    {
        ...
        protected void gvDetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            string alldata = TRANSTP + ", " + TRANSDT + ", " + TRANSMY + ", " + TRANSNO + ", " + SERIALNO + ", " + TRANSDRCR + ", " + TRANSFOR
                + ", " + COSTPID + ", " + TRANSMODE + ", " + DEBITCD + ", " + DEBITCD + ", " + CREDITCD + ", " + DEBITAMT + ", " + CREDITAMT + ", " + CHEQUENO
            ...
            SqlCommand cmdinsert = new SqlCommand("insert into ASL_DLT values('GL_MASTER',@DESCRP,@USERPC,@USERID,@INTIME,@IPADD)", conn);
