    ...
    public partial class RptCreditVoucherEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                lblVoDT.Text = Session["TransDate"].ToString();
                ...
                if (TransType == "MREC")
                {
                    ...
                    Global.lblAdd(@"select CONVERT(NVARCHAR,TRANSDT,103)  from GL_STRANS where TRANSDT ='" + TDT + "' and TRANSNO=" + transNo + " and DEBITCD='" + DebitCD + "' and CREDITCD='" + CreditCD + "'", lblTime);
