...
{
    public partial class RptExpHeadRegister : System.Web.UI.Page
    {
        ...
        public void ShowGrid()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT CONVERT(NVARCHAR(20),CNF_JOBEXP.TRANSDT ,103) AS TRANSD, CNF_JOBEXP.JOBNO, CNF_JOBEXP.JOBTP, CNF_JOBEXP.JOBYY, CNF_JOBEXP.EXPAMT, GL_ACCHART.ACCOUNTNM, ASL_COMPANY.BRANCHID FROM  CNF_JOBEXP INNER JOIN CNF_JOB ON CNF_JOBEXP.JOBYY = CNF_JOB.JOBYY AND CNF_JOBEXP.JOBTP = CNF_JOB.JOBTP AND CNF_JOBEXP.JOBNO = CNF_JOB.JOBNO INNER JOIN GL_ACCHART ON CNF_JOB.PARTYID = GL_ACCHART.ACCOUNTCD INNER JOIN ASL_COMPANY ON CNF_JOBEXP.COMPID = ASL_COMPANY.COMPID WHERE CNF_JOBEXP.TRANSDT BETWEEN @FROMDATE AND @TODATE AND CNF_JOBEXP.EXPID='" + expid + "'", conn);
        ...
        protected void gvReport_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[6].Text = totAmountComma;
