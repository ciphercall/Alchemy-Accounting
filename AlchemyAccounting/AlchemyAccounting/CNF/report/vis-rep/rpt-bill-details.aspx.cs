    ...
    public partial class rpt_bill_details : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var billyer = Global.StringData(@"SELECT DISTINCT DATEPART(YEAR,BILLDT) AS BILLDT FROM CNF_JOBBILL WHERE COMPID='" + compid + "' AND JOBYY=" + jobyear + " AND JOBTP='" + jobtp + "' AND JOBNO= " + jobno + " AND PARTYID= '" + partyid + "'");
                ...
                lblBillNo.Text = cmpid + "/" + jbtp + "/" + lblBill.Text + "/" + billyer;
                ...
                Global.lblAdd("SELECT ISNULL(ASSV_BDT,0) ASSV_BDT FROM CNF_JOB WHERE JOBNO =" + jobno + " AND JOBTP ='" + jobtp + "' AND JOBYY =" + jobyear + "", lblAssessableValue);
                lblAssessableValue.Text= SpellAmount.comma(Convert.ToDecimal(lblAssessableValue.Text));
