<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt-Periodic-summarized-Performace-Bill.aspx.cs" Inherits="AlchemyAccounting.CNF.report.vis_rep.rpt_Periodic_summarized_Performace_Bill" %>
   ...
   <div>
        <div>
            <table style="width: 100%; font-family: Calibri;">
                ...
                <tr>
                    <td style="width: 60%">
                        <strong>Periodic Summarized performance peport of C&F ( Sea +Air+Local) Bill Date Wise</strong>
                    </td>
                    <td style="text-align: right; width: 40%">
