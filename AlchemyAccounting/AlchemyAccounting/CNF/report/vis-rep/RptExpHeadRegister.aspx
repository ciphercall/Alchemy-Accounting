<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptExpHeadRegister.aspx.cs"
    Inherits="AlchemyAccounting.CNF.report.vis_rep.RptExpHeadRegister" %>
    ...
    <div>
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 15%">
                    <asp:Label ID="lblExpenseID" runat="server"></asp:Label>
                </td>
                <td style="width: 10%">
                    &nbsp;
                </td>
