<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt-jobtypw-wise.aspx.cs"
    Inherits="AlchemyAccounting.CNF.report.vis_rep.rpt_jobtypw_wise" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 58%; text-align: left; font-family: Calibri">
                        <strong>JOB TYPE WISE JOB REGISTER</strong>
                    </td>
                    <td style="width: 40%; text-align: right; font-size: 14px; font-family: Calibri">Print date :
            ...
            <table style="width: 100%">
                <tr>
                    <td style="width: 2%; text-align: left"></td>
                    <td style="width: 13%; text-align: left; font-family: Calibri; font-size: 14px;">Job Type
                    </td>
                    <td style="width: 1%; text-align: center">:
                    </td>
                    <td style="width: 18%;">
                        <asp:Label runat="server" ID="lbljobtype" Font-Names="Calibri;font-size:14px;"></asp:Label>
                    </td>
            ...
            <table width="100%">
                <tr>
                    <td style="width: 2%; text-align: left"></td>
                    <td style="width: 13%; text-align: left; font-family: Calibri; font-size: 14px;">Job Year
                    </td>
                    <td style="width: 1%; text-align: center">:
                    </td>
                    <td style="width: 43%">
            ...
            <div style="width: 96%; margin: 1% 2% 0% 2%;">
                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" Font-Names="Calibri"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="BENO" HeaderText="B/E No">
                            <HeaderStyle HorizontalAlign="Center" Width="5%" />
                            <ItemStyle HorizontalAlign="Left" Width="5%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="BEDT" HeaderText="B/E Date">
                            <HeaderStyle HorizontalAlign="Center" Width="5%" />
                            <ItemStyle HorizontalAlign="Left" Width="5%" />
                        </asp:BoundField>
