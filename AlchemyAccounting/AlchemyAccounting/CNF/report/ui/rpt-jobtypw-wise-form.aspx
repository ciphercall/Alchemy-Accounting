<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="rpt-jobtypw-wise-form.aspx.cs" Inherits="AlchemyAccounting.CNF.report.ui.rpt_jobtypw_wise_form" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td style="width: 84%; margin-left: 120px;">
                    <asp:DropDownList runat="server" ID="ddljobtype" CssClass="txtColor center" Width="30%"
                        Height="22px" TabIndex="1" OnTextChanged="ddljobtype_TextChanged" 
                        AutoPostBack="True">
            ...
            <tr>
                ...
                <td style="width: 84%">
                    <asp:TextBox runat="server" ID="txtJobYY" CssClass="txtColor center" Width="30%"
                        TabIndex="3" AutoPostBack="True" Height="22px" OnTextChanged="txtJobYY_TextChanged"></asp:TextBox>
            ...
            <tr>
                ...
                <td style="width: 84%">
                    <asp:Button ID="btnSubmit" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="15px"
                        TabIndex="5" Text="View Report" Width="110px" OnClick="btnSubmit_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
