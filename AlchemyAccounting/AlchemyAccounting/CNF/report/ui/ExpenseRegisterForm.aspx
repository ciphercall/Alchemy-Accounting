<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ExpenseRegisterForm.aspx.cs" Inherits="AlchemyAccounting.CNF.report.ui.ExpenseRegisterForm" %>
    ...
    <div class="def">
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="width: 15%">
                    <asp:TextBox runat="server" ID="txtExpenseNM" CssClass="txtColor" Width="201%" AutoPostBack="True"
                        OnTextChanged="txtExpenseNM_TextChanged"></asp:TextBox>
                    <asp:AutoCompleteExtender ID="txtexpensebNo_AutoCompleteExtender" runat="server"
                        DelimiterCharacters="" Enabled="True" ServicePath="" TargetControlID="txtExpenseNM"
                        MinimumPrefixLength="1" CompletionInterval="10" EnableCaching="true" CompletionSetCount="3"
                        UseContextKey="True" ServiceMethod="GetCompletionListParty" CompletionListCssClass="completionList"
