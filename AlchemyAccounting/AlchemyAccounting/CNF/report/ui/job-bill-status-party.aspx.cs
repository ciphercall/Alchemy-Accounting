...
{
    public partial class job_bill_status_party : System.Web.UI.Page
    {
        ...
        protected void txtPartyNM_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                lblErrmsg.Visible = true;
                lblErrmsg.Text = "Select Party.";
                txtPartyNM.Focus();
            }
            else
            {
                lblPartyID.Text = "";
                Global.lblAdd("SELECT ACCOUNTCD FROM GL_ACCHART WHERE ACCOUNTNM ='" + txtPartyNM.Text + "' AND STATUSCD ='P'", lblPartyID);
                if (lblPartyID.Text == "")
                {
                    lblErrmsg.Visible = true;
                    lblErrmsg.Text = "Select Party.";
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Session["partynm"] = txtPartyNM.Text;
                    ...
                    Page.ClientScript.RegisterStartupScript(
                             this.GetType(), "OpenWindow", "window.open('../vis-rep/rpt-job-bill-status-party.aspx','_newtab');", true);
                }
            }
        }
    }
