<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Periodic-Detailed-Performace.aspx.cs" Inherits="AlchemyAccounting.CNF.report.ui.rpt_Periodic_Detailed_Performace" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <h3 align="center" style="font-weight: bold;">Periodic Detailed Performace Report of C&F (Sea+Air+Local) Job</h3>
    </div>
    ...
    <div>
        <div class="row">
            <%--<div class="col-md-5" style="border: 1px solid;">
                <table class="text-center" style="width: 100%; padding-bottom: 5PX">
                    <tr style="border-bottom: 1px solid">
                        <td><h4>Job Date Bill Wise Details</h4></td>
                    </tr>
                </table>
                <br/>
                <table style="width: 100%">
                    ...
                    <tr>
                        <td>Job Type</td>
                        <td>
                            <asp:DropDownList runat="server" ID="ddlJobType" CssClass="txtColor" Width="100%"
                    ...
                    <tr>
                        <td>Date From</td>
                        <td>
                            <asp:TextBox runat="server" ID="txtDateFrom" CssClass="txtColor center" Width="100%"
                    ...
                    <tr>
                        <td>Date To</td>
                        <td>
                            <asp:TextBox runat="server" ID="txtDateTo" CssClass="txtColor center" Width="100%"
                    ...
                    <tr>
                     ...
                     <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btnView" runat="server" Text="View Details" Font-Bold="True" Font-Italic="False"
                                Width="100%" TabIndex="6" CssClass="txtColor center" OnClick="btnView_Click" />
                        </td>
                    </tr>
                </table>
                ...
                <br />
                 ...
                 <table class="text-center" style="width: 100%; padding-bottom: 5PX">
                    <tr style="border-bottom: 1px solid">
                        <td><h4>Job Date Bill Wise Summary</h4></td>
                    </tr>
                </table>
                <br/>
                <table style="width: 100%">
                     <tr>
                        <td>Date From</td>
                        <td>
                            <asp:TextBox runat="server" ID="txtDateFromForSummury" CssClass="txtColor center" Width="100%"
                                TabIndex="4"></asp:TextBox>
                            <asp:CalendarExtender ID="CalendarExtender3" runat="server" CssClass="cal_Theme1 well"
                                Format="dd/MM/yyyy" TargetControlID="txtDateFromForSummury">
                            </asp:CalendarExtender>
                        </td>
                    </tr>
                    <tr>
                        <td>Date To</td>
                        <td>
                            <asp:TextBox runat="server" ID="txtDateToForSummury" CssClass="txtColor center" Width="100%"
                                TabIndex="5"></asp:TextBox>
                            <asp:CalendarExtender ID="CalendarExtender4" runat="server" CssClass="cal_Theme1 well"
                                Format="dd/MM/yyyy" TargetControlID="txtDateToForSummury">
                            </asp:CalendarExtender>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btnSummary" runat="server" Text="View Summary" Font-Bold="True" Font-Italic="False"
                                Width="100%" TabIndex="6" CssClass="txtColor center" OnClick="btnSummary_Click" />
                        </td>
                    </tr>
                </table>
            ...
            <div class="col-md-6" style="border: 1px solid;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnViewBill" runat="server" Text="View Details" Font-Bold="True" Font-Italic="False"
                                Width="100%" TabIndex="6" CssClass="txtColor center" OnClick="btnViewBill_Click" />
                        </td>
                    </tr>
                </table>
                ...
                <table class="text-center" style="width: 100%; padding-bottom: 5PX">
                    <tr style="border-bottom: 1px solid">
                        <td>
                            <h4>Bill Date Bill Wise Summary</h4>
                        </td>
                    </tr>
                </table>
                <br />
                <table style="width: 100%">
                    <tr>
                        <td>Date From</td>
                        <td>
                            <asp:TextBox runat="server" ID="txtDateFromBillSummarty" CssClass="txtColor center" Width="100%"
                                TabIndex="4"></asp:TextBox>
                            <asp:CalendarExtender ID="CalendarExtender7" runat="server" CssClass="cal_Theme1 well"
                                Format="dd/MM/yyyy" TargetControlID="txtDateFromBillSummarty">
                            </asp:CalendarExtender>
                        </td>
                    </tr>
                    <tr>
                        <td>Date To</td>
                        <td>
                            <asp:TextBox runat="server" ID="txtDateToBillSummarty" CssClass="txtColor center" Width="100%"
                                TabIndex="5"></asp:TextBox>
                            <asp:CalendarExtender ID="CalendarExtender8" runat="server" CssClass="cal_Theme1 well"
                                Format="dd/MM/yyyy" TargetControlID="txtDateToBillSummarty">
                            </asp:CalendarExtender>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btnBillSummary" runat="server" Text="View Summary" Font-Bold="True" Font-Italic="False"
                                Width="100%" TabIndex="6" CssClass="txtColor center" OnClick="btnBillSummary_Click" />
                        </td>
                    </tr>
                </table>
