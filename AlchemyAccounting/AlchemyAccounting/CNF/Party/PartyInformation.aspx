...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="header">
        <h1 align="center">Party Information Entry</h1>
    </div>
    <div id="entry">
        <div id="toolbar">
    ...
    <div class="def">
        <table style="width: 100%">
            <tr>
                <td style="width: 15%; text-align: right; font-weight: bold">Party Name
                </td>
            ...
            <tr>
                <td style="width: 15%; text-align: right; font-weight: bold">Address
                </td>
                <td style="width: 1%; text-align: center; font-weight: bold">:
                </td>
                <td style="text-align: left; font-weight: bold" class="style1">
            ...
            <tr>
                <td style="width: 15%; text-align: right; font-weight: bold">Contact No
                </td>
                <td style="width: 1%; text-align: center; font-weight: bold">:
                </td>
                <td style="text-align: left; font-weight: bold" class="style1">
            ...
            <tr>
                <td style="width: 15%; text-align: right; font-weight: bold">Email ID
                </td>
                <td style="width: 1%; text-align: center; font-weight: bold">:
                </td>
                <td style="text-align: left; font-weight: bold" class="style1">
            ...
            <tr>
                <td style="width: 15%; text-align: right; font-weight: bold">Web Address
                </td>
                <td style="width: 1%; text-align: center; font-weight: bold">:
                </td>
                <td style="text-align: left; font-weight: bold" class="style1">
            ...
            <tr>
                <td style="width: 15%; text-align: right; font-weight: bold">A.P. Name
                </td>
                <td style="width: 1%; text-align: center; font-weight: bold">:
                </td>
                <td style="text-align: left; font-weight: bold" class="style1">
            ...
            <tr>
                <td style="width: 15%; text-align: right; font-weight: bold">A.P. Contact No
                </td>
                <td style="width: 1%; text-align: center; font-weight: bold">:
                </td>
                <td style="text-align: left; font-weight: bold" class="style1">
            ...
            <tr>
                <td style="width: 15%; text-align: right; font-weight: bold">Login Email
                </td>
                <td style="width: 1%; text-align: center; font-weight: bold">:
                </td>
                <td style="text-align: left; font-weight: bold" class="style1">
                    <asp:TextBox ID="txtlogmail" runat="server" TabIndex="7" Width="90%" CssClass="txtColor"></asp:TextBox>
                    
                     <br />

                    <asp:Label ID="lblmailerror" runat="server" BackColor="Black" Visible="false"
                        ForeColor="#FF3300"></asp:Label>
                </td>
            </tr>
            ...
            <tr>
                <td style="width: 15%; text-align: right; font-weight: bold">Password
                </td>
                <td style="width: 1%; text-align: center; font-weight: bold">:
                </td>
                <td style="text-align: left; font-weight: bold" class="style1">
                    <asp:TextBox ID="txtpassword" runat="server" TabIndex="7" Width="90%" CssClass="txtColor"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                <td style="width: 15%; text-align: right; font-weight: bold">Status
                </td>
                <td style="width: 1%; text-align: center; font-weight: bold">:
                </td>
                <td style="text-align: left; font-weight: bold" class="style1">
