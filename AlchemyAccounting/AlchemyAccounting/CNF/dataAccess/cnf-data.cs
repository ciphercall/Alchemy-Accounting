        ...
        public string save_cnf_job(cnf_model ob)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "INSERT INTO CNF_JOB (JOBCDT, COMPID, REGID, JOBYY, JOBTP, JOBNO, PARTYID, CONSIGNEENM, CONSIGNEEADD, SUPPLIERNM, PKGS, GOODS, WTGROSS, WTNET, CNFV_USD, CNFV_ETP," +
                      " CNFV_ERT, CNFV_BDT, CRFV_USD, ASSV_BDT, COMM_AMT, CONTNO, DOCINVNO, DOCRCVDT, CRFNO, CRFDT, BENO, BEDT, BLNO, BLDT, LCNO, LCDT, PERMITNO, PERMITDT, DELIVERYDT, WFDT, AWBNO, AWBDT, HBLNO, HBLDT, HAWBNO, HAWBDT, UNTKNO, UNTKDT, COM_REMARKS, STATUS, USERPC, USERID, INTIME, IPADDRESS, FVESSEL, ROTNO,ETADT, ETBDT, UDNO, UDDT, EXPFNO, EXPFDT) " +
                ...
                cmd.Parameters.Add("@FVESSEL", SqlDbType.NVarChar).Value = ob.FVessel;
                cmd.Parameters.Add("@ROTNO", SqlDbType.NVarChar).Value = ob.RotNo;
                cmd.Parameters.Add("@ETADT", SqlDbType.DateTime).Value = ob.EtaDate;
                cmd.Parameters.Add("@ETBDT", SqlDbType.DateTime).Value = ob.EtbDate;
                cmd.Parameters.Add("@UDNO", SqlDbType.NVarChar).Value = ob.UdNo;
                cmd.Parameters.Add("@UDDT", SqlDbType.DateTime).Value = ob.UdDate;
                cmd.Parameters.Add("@EXPFNO", SqlDbType.NVarChar).Value = ob.ExpFNo;
                cmd.Parameters.Add("@EXPFDT", SqlDbType.DateTime).Value = ob.ExpFDate;
        ...
        public string update_cnf_job(cnf_model ob)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "UPDATE CNF_JOB SET JOBCDT =@JOBCDT, REGID =@REGID, PARTYID =@PARTYID, CONSIGNEENM =@CONSIGNEENM, CONSIGNEEADD =@CONSIGNEEADD, SUPPLIERNM =@SUPPLIERNM, PKGS =@PKGS, GOODS =@GOODS, WTGROSS =@WTGROSS, " +
                      ...
                      " UNTKNO =@UNTKNO, UNTKDT =@UNTKDT, COM_REMARKS =@COM_REMARKS, STATUS =@STATUS,FVESSEL=@FVESSEL, ROTNO=@ROTNO, ETADT=@ETADT, " +
                      "ETBDT=@ETBDT, UDNO=@UDNO, UDDT=@UDDT, EXPFNO=@EXPFNO, EXPFDT=@EXPFDT, USERPC =@USERPC, UPDATEUSERID =@UPDATEUSERID, UPDATETIME =@UPDATETIME, IPADDRESS =@IPADDRESS WHERE JOBYY =@JOBYY AND JOBTP =@JOBTP AND JOBNO =@JOBNO";
                cmd.Parameters.Clear();
                cmd.Parameters.Add("@JOBCDT", SqlDbType.Date).Value = ob.JobCrDT;
                cmd.Parameters.Add("@REGID", SqlDbType.NVarChar).Value = ob.RegID;
                cmd.Parameters.Add("@JOBYY", SqlDbType.Int).Value = ob.JobYear;
