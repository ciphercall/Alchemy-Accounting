<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="job-incom-bill.aspx.cs" Inherits="AlchemyAccounting.CNF.report.ui.job_incom_bill" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="header">
        <h1 align="center" style="font-weight:bold;">Job - Incomplete for Bill</h1>
    </div>
    <div>
        ...
        <table id="s_top">
            ...
            <tr>
                ...
                <td class="style1">
                    <strong>:</strong></td>
                <td class="style2">
                    <asp:TextBox runat="server" ID="txtBranchID" CssClass="txtColor" Width="100%"
                    ...
                    <asp:AutoCompleteExtender ID="AutoCompleteExtender1" Enabled="True" ServicePath="" CompletionListCssClass="completionList"
                        TargetControlID="txtBranchID" MinimumPrefixLength="1" CompletionInterval="10" 
                        EnableCaching="true" CompletionSetCount="3" UseContextKey="True" ServiceMethod="GetCompletionListBranchID"
                        runat="server">
            ...
            <tr>
                ...
                <td class="style1">
                    <strong>:</strong></td>
                <td class="style2">
                    <asp:DropDownList runat="server" ID="ddlJobType" CssClass="txtColor" 
                        Width="50%" TabIndex="2"
            ...
            <tr>
                ...
                <td class="style1">
                    <strong>:</strong></td>
                <td class="style2">
                    <asp:TextBox runat="server" ID="txtJobYear" CssClass="txtColor center" 
                        Width="50%" TabIndex="3"
                        AutoPostBack="True" OnTextChanged="txtJobYear_TextChanged"></asp:TextBox>
            ...
            <tr>
                <td class="style3">
                    <asp:Label ID="lblbranchtag" runat="server" Text="Branch Name" Visible="false"></asp:Label></td>
                <td class="style1">
            ...
            <tr>
                ...
                <td style="text-align: right" class="style2">
                    <asp:Button ID="btnView" runat="server" Text="View Report" Font-Bold="True" 
                        Font-Italic="False" Width="150px" TabIndex="3" CssClass="txtColor center" 
