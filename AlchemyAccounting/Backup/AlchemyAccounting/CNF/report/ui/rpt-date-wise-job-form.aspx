<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt-date-wise-job-form.aspx.cs" Inherits="AlchemyAccounting.CNF.report.ui.rpt_date_wise_job_form" %>
            ...
            <tr>
                ...
                <td style="width: 15%">
                    <asp:TextBox runat="server" ID="txtFromDate" CssClass="txtColor" Width="90%" AutoPostBack="True"
                        OnTextChanged="txtFromDate_TextChanged" Height="22px" TabIndex="1"></asp:TextBox>
