<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt-party-jobyy-wise-job-form.aspx.cs" Inherits="AlchemyAccounting.CNF.report.ui.rpt_party_jobyy_wise_job_form" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td style="width: 84%; margin-left: 120px;">
                    <asp:TextBox runat="server" ID="txtparty" CssClass="txtColor center" Width="30%"
                        Height="22px" TabIndex="1" OnTextChanged="txtparty_TextChanged" 
                        AutoPostBack="True">                       
                    </asp:TextBox>
                    ...
                    <asp:TextBox runat="server" ID="txtpatyID" CssClass="txtColor center" Width="30%"
                        Height="22px" TabIndex="1" Enabled="False" Visible="False" ></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 15%; text-align: right; font-weight: bold">
            ...
            <tr>
                ...
                <td style="width: 84%">
                    <asp:TextBox runat="server" ID="txtJobYY" CssClass="txtColor center" Width="30%"
                        TabIndex="2" AutoPostBack="True" Height="22px" OnTextChanged="txtJobYY_TextChanged"></asp:TextBox>
                    <asp:AutoCompleteExtender ID="AutoCompleteExtender3" Enabled="True" ServicePath=""
                        TargetControlID="txtJobYY" MinimumPrefixLength="1" CompletionInterval="10" EnableCaching="true"
                        CompletionSetCount="3" UseContextKey="True" ServiceMethod="GetCompletionListYear"
                        runat="server">
                    </asp:AutoCompleteExtender>
                    &nbsp;&nbsp;
                </td>
            ...
            <tr>
                ...
                <td style="width: 84%">
                    <asp:Button ID="btnSubmit" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="15px"
                        TabIndex="3" Text="View Report" Width="110px" OnClick="btnSubmit_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
