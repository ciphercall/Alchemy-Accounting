<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RptExpHeadRegisterForm.aspx.cs" Inherits="AlchemyAccounting.CNF.report.ui.RptExpHeadRegisterForm" %>
    ...
    <div class="def">
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="width: 15%">
                    <asp:TextBox runat="server" ID="txtExpenseNM" CssClass="txtColor" Width="201%"
                        AutoPostBack="True" OnTextChanged="txtExpenseNM_TextChanged"></asp:TextBox>

                    <asp:AutoCompleteExtender ID="txtexpensebNo_AutoCompleteExtender" runat="server" DelimiterCharacters=""
                        ...
                        ServiceMethod="GetCompletionListExpenseID" CompletionListCssClass="completionList"
                ...
                <td style="width: 16%">
                    <asp:TextBox runat="server" ID="txtExpenseID" CssClass="txtColor" Width="100%" ReadOnly="true"
