<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptImportInfo.aspx.cs"
    Inherits="AlchemyAccounting.CNF.report.vis_rep.RptImportInfo" %>
    ...
    <div>
        ...
        <table style="width: 100%">
            <%--<tr>
                ...
                <td style="width: 48%; text-align: left; font-size: 14px; font-family: Calibri">
                    Job Type &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    :&nbsp;&nbsp;
             ...
             <tr>
                ...
                <td style="width: 56%; text-align: right; font-size: 14px; font-family: Calibri;">
                    <span class="style2">Print date :
                    </span>
                    <asp:Label ID="lblPrintDate" runat="server" Font-Names="Calibri" 
        ...
        <table width="100%">
            <tr>
                ...
                <td style="width: 98%; text-align: left; font-family: Calibri; font-size: 14px;">
                    SUB : Forwarding Bill details as follows :
                </td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                ...
                <td style="width: 10%; text-align: left; font-family: Calibri; font-size: 14px; font-weight: bold">
                    In Words&nbsp;
                </td>
        ...
        <table>
            ...
            <tr>
                ...
                <td style="width: 98%; font-size: 15px;" class="style1">
                    Your Faithfully
                </td>
            </tr>
            <tr>
