...
namespace AlchemyAccounting.CNF.report.vis_rep
{
    public partial class ExpenseRegisterDetails : System.Web.UI.Page
    {
        ...
        public void ShowGrid()
        {
            ...
            Global.lblAdd("select ACCOUNTNM from GL_ACCHART where ACCOUNTCD='" + expcd + "' AND STATUSCD ='P'", lblExpenseHD);
            ...
            SqlCommand cmd = new SqlCommand("SELECT ( CONVERT(NVARCHAR(20), CNF_JOBEXP.JOBNO,103 ) + '-' + CNF_JOBEXP.JOBTP + '-' +  CONVERT(NVARCHAR(20),CNF_JOBEXP.JOBYY,103)) AS JB, ASL_COMPANY.BRANCHID, GL_ACCHART.ACCOUNTNM,  " +
                      ...
                      " ASL_COMPANY ON CNF_JOBEXP.COMPID = ASL_COMPANY.COMPID INNER JOIN " +
