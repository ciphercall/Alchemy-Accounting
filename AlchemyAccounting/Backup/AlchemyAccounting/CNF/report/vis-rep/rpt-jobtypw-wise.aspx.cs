...
namespace AlchemyAccounting.CNF.report.vis_rep
{
    public partial class rpt_jobtypw_wise : System.Web.UI.Page
    {
        ...
        public void ShowGrid()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT CNF_JOB.JOBNO, GL_ACCHART.ACCOUNTNM,CNF_JOB.REGID, CONVERT(NVARCHAR(20), CNF_JOB.JOBCDT,103) AS JOBCDT, CNF_JOB.GOODS, CNF_JOB.PKGS, CNF_JOB.PERMITNO, CNF_JOB.DOCINVNO, " +
