...
namespace AlchemyAccounting.CNF.report.vis_rep
{
    public partial class RptJobInfo : System.Web.UI.Page
    {
        ...
        public void ShowGrid()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT CNF_JOB.JOBNO, GL_ACCHART.ACCOUNTNM, CNF_JOB.REGID, CNF_JOB.GOODS, CNF_JOB.PKGS, CNF_JOB.PERMITNO, CNF_JOB.DOCINVNO FROM CNF_JOB INNER JOIN ASL_COMPANY ON CNF_JOB.COMPID = ASL_COMPANY.COMPID INNER JOIN GL_ACCHART ON CNF_JOB.PARTYID = GL_ACCHART.ACCOUNTCD " +
