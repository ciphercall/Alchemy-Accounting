...
namespace AlchemyAccounting.CNF.report.vis_rep
{
    public partial class rpt_date_wise_job : System.Web.UI.Page
    {
        ...
        public void ShowGrid()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT CNF_JOB.JOBNO, GL_ACCHART.ACCOUNTNM, CNF_JOB.REGID, CNF_JOB.GOODS, CNF_JOB.PKGS, CNF_JOB.PERMITNO, CNF_JOB.DOCINVNO, " +
                     " ASL_COMPANY.COMPNM, CNF_JOB.JOBYY, CNF_JOB.JOBTP,(CASE WHEN CNF_JOB.DOCRCVDT ='1900-01-01' THEN NULL ELSE CONVERT(NVARCHAR(20), CNF_JOB.DOCRCVDT, 103) END) AS DOCRCVDT, (CASE WHEN CNF_JOB.PERMITDT ='1900-01-01' THEN NULL ELSE CONVERT(NVARCHAR(20), CNF_JOB.PERMITDT, 103) END) AS PERMITDT, ASL_COMPANY.BRANCHID " +
