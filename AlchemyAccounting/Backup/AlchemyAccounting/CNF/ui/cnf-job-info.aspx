    ...
    <div id="entry">
        ...
        <div class="cont">
            <table style="width: 100%; font-family: Calibri; font-size: 14px; font-weight: bold">
                ...
                <tr>
                    <td style="text-align: right" class="style14">
                        <asp:TextBox ID="txtNetWeight" runat="server" CssClass="txtColor txtalignright" TabIndex="18"
                            Visible="false" Width="50%">.00</asp:TextBox>
                        C&amp;F Value (USD)
                    </td>
                    <td style="width: 1%">
                        :
                    ...
                    <td style="width: 25%">
                        <asp:TextBox ID="txtCNFVUSD" runat="server" CssClass="txtColor txtalignright" TabIndex="13"
                            Width="50%" AutoPostBack="True" ontextchanged="txtCNFVUSD_TextChanged">.00</asp:TextBox>
                    </td>
                    ...
                    <td style="width: 29%">
                        <asp:TextBox ID="txtCRFVUSD" runat="server" CssClass="txtColor txtalignright" TabIndex="14"
                            Width="50%">.00</asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right" class="style14">
                        <asp:TextBox ID="txtGrossWeight" runat="server" CssClass="txtColor txtalignright"
                            Visible="false" TabIndex="17" Width="50%">.00</asp:TextBox>
                        Exchange Rate &amp; Type&nbsp;
                    </td>
                    <td style="width: 1%">
                        :
                    ...
                    <td style="width: 25%">
                        <asp:TextBox ID="txtChangeRT" runat="server" CssClass="txtColor txtalignright" TabIndex="15"
                            Width="50%" AutoPostBack="True" OnTextChanged="txtChangeRT_TextChanged">.00</asp:TextBox>
                    ...
                    <td style="width: 29%">
                        <asp:TextBox ID="txtCNFVBDT" runat="server" CssClass="txtColor txtalignright" TabIndex="17"
                            Width="50%" ReadOnly="True">.00</asp:TextBox>
                    </td>
                </tr>
                <%--                                <tr>
                    <td style="text-align: right" class="style14">
                ...
                <tr>
                    ...
                    <td style="width: 25%">
                        <asp:TextBox ID="txtAssessableVal" runat="server" CssClass="txtColor txtalignright"
                            ...
                            ontextchanged="txtAssessableVal_TextChanged">.00</asp:TextBox>
                    ...
                    <td style="width: 29%">
                        <asp:TextBox ID="txtCommission" runat="server" CssClass="txtColor txtalignright"
                            TabIndex="19" Width="50%">.00</asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right" class="style14">
                ...
                <tr>
                    ...
                    <td style="width: 15%; text-align: right">
                        Under Taking Date :</td>
                    <td style="width: 29%">
                        <asp:TextBox ID="txtUnderTakeDt" runat="server" AutoPostBack="True" CssClass="txtColor"
                            OnTextChanged="txtUnderTakeDt_TextChanged" TabIndex="39" Width="30%"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td style="width: 1%">
                        :</td>
                    <td style="width: 25%">
                        <asp:TextBox ID="txtContainerNo" runat="server" CssClass="txtColor" TabIndex="40" 
                            Width="50%"></asp:TextBox>
                    </td>
                    <td style="width: 15%; text-align: right">
                        &nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="width: 1%">
                        :</td>
                    <td style="width: 25%">
                        <asp:TextBox ID="txtComRemarks" runat="server" CssClass="txtColor" TabIndex="41" 
                ...
                <tr>
                    ...
                    <td style="width: 25%">
                        <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="True" CssClass="txtColor"
                            OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" TabIndex="42" 
                            Width="30%">
                ...
                <tr>
                    ...
                    <td style="width: 25%">
                        <asp:Button ID="btnSave" runat="server" CssClass="txtColor txtaligncenter" Font-Bold="True"
                            TabIndex="43" Text="Save" Width="50%" OnClick="btnSave_Click" 
                            Height="30px" />
                    </td>
                    <td style="width: 15%; text-align: right">
                        &nbsp;
