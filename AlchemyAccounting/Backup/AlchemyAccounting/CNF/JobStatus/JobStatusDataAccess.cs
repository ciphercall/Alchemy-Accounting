    ...
    public class JobStatusDataAccess
    {
        ...
        public string Job_Bill_Process(JobStatusModel jsm)
        {
            ...
            try
            {
                ...
                cmd.CommandText = " INSERT INTO CNF_JOBBILL (PROCESSDT, COMPID, JOBYY, JOBTP, JOBNO, PARTYID, BILLDT, BILLNO, EXPSL, EXPID, EXPAMT, USERPC, INTIME, IPADDRESS) " +
                    " VALUES (@PROCESSDT, @COMPID, @JOBYY, @JOBTP, @JOBNO, @PARTYID, @BILLDT, @BILLNO, @EXPSL, @EXPID, @EXPAMT, @USERPC, @INTIME, @IPADDRESS)";
                cmd.Parameters.Clear();
