    ...
    public class PartyCommissionDataAccess
    {
        ...
        public string SaveExpenseInfo(PartyCommissionModel pcm)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "insert into CNF_COMMISSION (PARTYID, COMMSL, EXCTP, VALUEFR,VALUETO,VALUETP, COMMAMT, USERPC, INTIME, UPDATETIME, IPADDRESS)" +
                    "values(@PARTYID, @COMMSL,@EXCTP, @VALUEFR,@VALUETO, @VALUETP, @COMMAMT, @USERPC, @INTIME , @UPDATETIME,@IPADDRESS  )";
        ...
        public string UpdateExpenseInfo(PartyCommissionModel pcm)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "update CNF_COMMISSION set EXCTP=@EXCTP ,VALUEFR=@VALUEFR, VALUETO=@VALUETO, VALUETP=@VALUETP, COMMAMT=@COMMAMT where PARTYID=@PARTYID and COMMSL=@COMMSL ";
