    ...
    public class PartyInformationDataAccess
    {
        ...
        public string CreateParty(PartyInformationModel pim)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "insert into CNF_PARTY (PARTYID, ADDRESS, CONTACTNO, EMAILID,WEBID,APNM,APNO,STATUS, USERPC, INTIME, UPDATETIME, IPADDRESS)" +
                    "values(@PARTYID, @ADDRESS,@CONTACTNO, @EMAILID, @WEBID,@APNM,@APNO,@STATUS, @USERPC, @INTIME , @UPDATETIME,@IPADDRESS  )";
        ...
        public string UpdateParty(PartyInformationModel pim)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "update CNF_PARTY set ADDRESS=@ADDRESS, CONTACTNO=@CONTACTNO, EMAILID=@EMAILID, WEBID=@WEBID, APNM=@APNM, APNO=@APNO, STATUS=@STATUS where PARTYID=@PARTYID";
