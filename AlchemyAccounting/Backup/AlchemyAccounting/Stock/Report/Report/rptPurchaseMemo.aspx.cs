    ...
    public partial class rptPurchaseMemo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string InvNo_P = Session["InvNo_P"].ToString();
        ...
        public void showGrid()
        {
            ...
            SqlCommand cmd = new SqlCommand(" SELECT ROW_NUMBER() over (order by STK_TRANS.TRANSSL) as SL, dbo.STK_ITEMMST.CATNM, dbo.STK_ITEM.ITEMNM, " +
                             ...
                             " WHERE (dbo.STK_TRANS.TRANSTP = 'BUY') AND (dbo.STK_TRANS.TRANSDT = '" + inDate + "') AND (dbo.STK_TRANS.TRANSNO = '" + InvNo_P + "') AND " +
