        ...
        public void showGrid_Credit()
        {
            ...
            if (uTp == "ADMIN")
            {
                cmd = new SqlCommand(" SELECT GL_MASTER.TRANSTP,(CASE WHEN GL_MASTER.TABLEID = 'GL_STRANS' THEN SUBSTRING(GL_MASTER.TABLEID, 4, 1) " +
                                  ...
                                  " WHERE (GL_MASTER.TRANSDT BETWEEN '" + FrDT + "' AND '" + ToDT + "') AND (GL_MASTER.TABLEID = 'GL_STRANS') AND GL_MASTER.TRANSDRCR='DEBIT' and GL_MASTER.TRANSTP = 'MREC'" +
            ...
            else
            {
                cmd = new SqlCommand(" SELECT GL_MASTER.TRANSTP,(CASE WHEN GL_MASTER.TABLEID = 'GL_STRANS' THEN SUBSTRING(GL_MASTER.TABLEID, 4, 1) " +
                                  ...
                                  " GL_ACCHART ON GL_MASTER.DEBITCD = GL_ACCHART.ACCOUNTCD INNER JOIN " +
                                  " GL_ACCHART AS GL_ACCHART_1 ON GL_MASTER.CREDITCD = GL_ACCHART_1.ACCOUNTCD " +
                                  " WHERE (GL_MASTER.TRANSDT BETWEEN '" + FrDT + "' AND '" + ToDT + "') AND (GL_MASTER.TABLEID = 'GL_STRANS') AND GL_MASTER.TRANSDRCR='DEBIT' and GL_MASTER.TRANSTP = 'MREC' AND (SUBSTRING(GL_MASTER.COSTPID, 1,3)='" + brCD + "')" +
                                  " ORDER BY TRANSDT, TRANSTP DESC,TRANSNO ASC", conn);
            }
        ...
        public void showGrid_Debit()
        {
            ...
            if (uTp == "ADMIN")
            {
                cmd = new SqlCommand(" SELECT GL_MASTER.TRANSTP,(CASE WHEN GL_MASTER.TABLEID = 'GL_STRANS' THEN SUBSTRING(GL_MASTER.TABLEID, 4, 1) " +
                                  ...
                                  " GL_ACCHART ON GL_MASTER.DEBITCD = GL_ACCHART.ACCOUNTCD INNER JOIN " +
                                  " GL_ACCHART AS GL_ACCHART_1 ON GL_MASTER.CREDITCD = GL_ACCHART_1.ACCOUNTCD " +
                                  " WHERE (GL_MASTER.TRANSDT BETWEEN '" + FrDT + "' AND '" + ToDT + "') AND (GL_MASTER.TABLEID IN ('GL_STRANS','LC_EXPENSE')) AND GL_MASTER.TRANSDRCR='DEBIT' and GL_MASTER.TRANSTP = 'MPAY'" +
                                  " ORDER BY TRANSDT, TRANSTP DESC,TRANSNO ASC", conn);
            }
            else
            {
                cmd = new SqlCommand(" SELECT GL_MASTER.TRANSTP,(CASE WHEN GL_MASTER.TABLEID = 'GL_STRANS' THEN SUBSTRING(GL_MASTER.TABLEID, 4, 1) " +
                                  ...
                                  " GL_ACCHART ON GL_MASTER.DEBITCD = GL_ACCHART.ACCOUNTCD INNER JOIN " +
                                  " GL_ACCHART AS GL_ACCHART_1 ON GL_MASTER.CREDITCD = GL_ACCHART_1.ACCOUNTCD " +
                                  " WHERE (GL_MASTER.TRANSDT BETWEEN '" + FrDT + "' AND '" + ToDT + "') AND (GL_MASTER.TABLEID IN ('GL_STRANS','LC_EXPENSE')) AND GL_MASTER.TRANSDRCR='DEBIT' and GL_MASTER.TRANSTP = 'MPAY' AND (SUBSTRING(GL_MASTER.COSTPID, 1,3)='" + brCD + "')" +
                                  " ORDER BY TRANSDT, TRANSTP DESC,TRANSNO ASC", conn);
            }
        ...
        public void showGrid_Journal()
        {
            ...
            if (uTp == "ADMIN")
            {
                cmd = new SqlCommand(" SELECT GL_MASTER.TRANSTP,(CASE WHEN GL_MASTER.TABLEID = 'GL_STRANS' THEN SUBSTRING(GL_MASTER.TABLEID, 4, 1) " +
                                  ...
                                  " GL_ACCHART ON GL_MASTER.DEBITCD = GL_ACCHART.ACCOUNTCD INNER JOIN " +
                                  " GL_ACCHART AS GL_ACCHART_1 ON GL_MASTER.CREDITCD = GL_ACCHART_1.ACCOUNTCD " +
                                  " WHERE (GL_MASTER.TRANSDT BETWEEN '" + FrDT + "' AND '" + ToDT + "') AND (GL_MASTER.TABLEID IN ('GL_STRANS','STK_TRANS')) AND GL_MASTER.TRANSDRCR='DEBIT' and GL_MASTER.TRANSTP = 'JOUR'" +
                                  " ORDER BY TRANSDT, TRANSTP DESC,TRANSNO ASC", conn);
            }
            else
            {
        ...
        public void showGrid_Contra()
        {
            ...
            if (uTp == "ADMIN")
            {
                cmd = new SqlCommand(" SELECT GL_MASTER.TRANSTP,(CASE WHEN GL_MASTER.TABLEID = 'GL_STRANS' THEN SUBSTRING(GL_MASTER.TABLEID, 4, 1) " +
                                   ...
                                   " GL_ACCHART ON GL_MASTER.DEBITCD = GL_ACCHART.ACCOUNTCD INNER JOIN " +
                                   " GL_ACCHART AS GL_ACCHART_1 ON GL_MASTER.CREDITCD = GL_ACCHART_1.ACCOUNTCD " +
                                   " WHERE (GL_MASTER.TRANSDT BETWEEN '" + FrDT + "' AND '" + ToDT + "') AND (GL_MASTER.TABLEID = 'GL_STRANS') AND GL_MASTER.TRANSDRCR='DEBIT' and GL_MASTER.TRANSTP = 'CONT'" +
                                   " ORDER BY TRANSDT, TRANSTP DESC,TRANSNO ASC", conn);
            }
            else
            {
                cmd = new SqlCommand(" SELECT GL_MASTER.TRANSTP,(CASE WHEN GL_MASTER.TABLEID = 'GL_STRANS' THEN SUBSTRING(GL_MASTER.TABLEID, 4, 1) " +
                                                   ...
                                                   " GL_ACCHART ON GL_MASTER.DEBITCD = GL_ACCHART.ACCOUNTCD INNER JOIN " +
                                                   " GL_ACCHART AS GL_ACCHART_1 ON GL_MASTER.CREDITCD = GL_ACCHART_1.ACCOUNTCD " +
                                                   " WHERE (GL_MASTER.TRANSDT BETWEEN '" + FrDT + "' AND '" + ToDT + "') AND (GL_MASTER.TABLEID = 'GL_STRANS') AND GL_MASTER.TRANSDRCR='DEBIT' and GL_MASTER.TRANSTP = 'CONT' AND (SUBSTRING(GL_MASTER.COSTPID, 1,3)='" + brCD + "')" +
                                                   " ORDER BY TRANSDT, TRANSTP DESC,TRANSNO ASC", conn);
            }
