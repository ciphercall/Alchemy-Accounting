<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptTrialBalanceDetails.aspx.cs" Inherits="AlchemyAccounting.Accounts.Report.Report.rptTrailBalanceDetails" %>
        ...
        <div>
            ...
            <tr>
                <td class="style12">
                    &nbsp;</td>
                <td class="style1">
                    <span class="style2"><strong>TRIAL BALANCE DETAILS</strong></span></td>
                <td style="text-align: right" class="style16">
