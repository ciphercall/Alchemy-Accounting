...
namespace AlchemyAccounting.Accounts.Report.Report
{
    public partial class rptTrailBalanceDetails : System.Web.UI.Page
    {
        ...
        string dblGrandTotalOPDRAmountComma = "0";
        string dblGrandTotalOPCRAmountComma = "0";
        string dblGrandTotalFRDRAmountComma = "0";
        string dblGrandTotalTOCRAmountComma = "0";
        string dblGrandTotalCLDRAmountComma = "0";
        string dblGrandTotalCLCRAmountComma = "0";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            info.AddMergedColumns(new int[] { 3, 4 }, "DATE WISE");
        ...
        public void showGrid()
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand(" SELECT TOT.DEBITCD, GL_ACCHART.ACCOUNTNM, TOT.OPDEBIT, TOT.OPCREDIT, TOT.FRDEBIT, TOT.TOCREDIT, TOT.CLDEBIT, TOT.CLCREDIT " +
                      ...
                      " GL_ACCHART ON TOT.DEBITCD = GL_ACCHART.ACCOUNTCD", conn);
